...
def func_open():
    ...
    displayPhoto(outPhoto, outY, outX)
...
def func_rotate():
    scale = askinteger("회전", "회전할 각도를 입력하세요", minvalue=0, maxvalue=360)
    outPhoto = inPhoto.copy()
...
fileMenu.add_command(label="파열 열기", command=func_open)
